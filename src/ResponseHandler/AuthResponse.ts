...
*******************************************End Of Auth OK*******************************************
	...
	`;
		...
		console.log(`Error in sendAuthorzationSuccess Auth logging: ${err}`);
	}
};
...
*******************************************End Of Auth Failed*******************************************
	...
	`;
		...
		res
			.status(401)
			.json({ ...data, unAuthenticated: true, authenticated: false });
	} catch (error) {
		const err = new Error(`S${error}`);
		console.log(`Error in sendUnAuthenticated Auth logging: ${err}`);
	}
};
...
*******************************************End Of Auth Failed*******************************************
	...
	`;
		...
		res.status(403).json({ ...data, unAuthorized: true, authenticated: false });
	} catch (error) {
		const err = new Error(`S${error}`);
		console.log(`Error in sendUnAuthorized Auth logging: ${err}`);
	}
};
