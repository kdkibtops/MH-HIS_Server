...
import { bills, payment_category, transactions, categories, item_movement, material, store, external_lab, external_lab_test, lab_order, lab_order_document, test, chronic_diseases_list, clinical, diabetes_description, hypertension_description, liver_condition, patient_chronic_diseases, patient_contacts, patient_imaging, patient_intervention, patient_investigation, patient_laboratory, patients_paperwork, personal, proc, proc_imaging, proc_lab, proc_paperwork, rad_order_document, radiology_order, study, study_preparation, qualification_categories, qualifications, job, user_role, user_contact } from "./";
